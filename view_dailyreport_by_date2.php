...
<div class="main-panel">
	...
	<h2>Eswari Homes - Daily Report by Date <?php if($_SESSION['role'] == 'superadmin'){ ?>&nbsp;&nbsp;&nbsp;<button id="export" class="btn btn-primary btn-xs">Export</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-xs" href="view_dailyreport_by_date.php">Search By Date</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-xs" href="view_dailyreport_inactive_emp.php">Reports by Inactive Empoyees</a>	<?php } ?></h2>
