...
class Manage_event extends CI_Controller { 
    ...
    public function index(){ 
        ...
        $data['property'] = $this->event->getRows(); 
          $data['status'] = 'All';
        // Load the list page view 
        $this->load->view('adminpanel/manage_event/index', $data); 
    ...
    public function view($id){
        $data = array(); 
         ...
         $this->loggedin();
                ...
                if(!empty($id)){ 
                    $data['property'] = $this->event->getRows($id); 
    ...
    public function add(){ 
        ...
        if($this->input->post('imgSubmit')){ 
            ...
            if($this->form_validation->run() == true){ 
                // Insert gallery data 
                $insert = $this->event->insert($propertydata); 
                $galleryID = $insert;  
                ...
                if($insert){ 
                    if(!empty($_FILES['images']['name'])){ 
                        ...
                        if(!empty($uploadData)){ 
                            ...
                            $insert = $this->event->insertImage($uploadData); 
                        } 
                    } 
                     
                    $this->session->set_userdata('success_msg', 'Event has been added successfully.'.$errorUpload); 
       ...
       $this->load->view('adminpanel/manage_event/add-edit', $data);
        $this->load->view('adminpanel/footer'); 
    } 
    ...
    public function edit($id){ 
          ...
          $con = array( 
           ...
           $data['user'] = $this->user->getRows($con);          
        $data = $propertydata = array(); 
        $propertydata = $this->event->getRows($id); 
        ...
        if($this->input->post('imgSubmit')){ 
            ...
            if($this->form_validation->run() == true){ 
                ...
                $update = $this->event->update($propertydata, $id); 
    ...
    public function delete($id){ 
        ...
        if($id){ 
            ...
            if($delete){ 
                ...
                $deleteImg = $this->event->deleteImage($condition);  
                  
                // Remove files from the server  
                if(!empty($propertydata['images'])){  
                    foreach($propertydata['images'] as $img){  
                        @unlink('uploads/events/'.$img['file_name']);  
                    }  
                }  
