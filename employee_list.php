...
<?php
    $result = mysqli_query($mysqli, "SELECT login.* FROM login where id > 40 and status != 'inactive' and company='at'");
  ?>
   ...
   <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Ase Technologies Employees List</h3>
