...
<head>
    ...
    <link rel="icon" href="./images/Parimi_Logo_icon.png">
...
<body>
    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center position-fixed">

        <!-- Navbar Start -->
        <nav class="navbar container-fluid mt-5 pt-5">
            <div class="container-fluid mx-5">
                <a class="navbar-brand">
                    <img src="./images/parimi_logo.png" alt="Parimi's Dental Care" style="max-height: 110px;" class="h-100">
                </a>
                <!-- <div class="d-flex mr-5 pr-5">
                    <a href="registration.php" class="btn nav-item nav-link text-white"><b>Registration</b></a>
                </div> -->
            </div>
        </nav>
        <!-- Navbar End -->
