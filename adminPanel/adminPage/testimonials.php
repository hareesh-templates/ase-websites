...
?>
    ...
    <title>Parimi's Dental Care _ Admin Panel - Testimonial Information</title>
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg bg-secondary fixed-tops navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="index.php" class="nav-item nav-link">Blogs</a>
        ...
        <div class="container mt-1">
            <div class="content">
                <h2 class="text-dark my-4">Testimonial Information</h2>
                <?php
