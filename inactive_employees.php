...
<?php
    $result = mysqli_query($mysqli, "SELECT login.* FROM login where id > 40 and status != 'active'");
  ?>
   ...
   <div class="main-panel">
          <div class="content-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="employees.php">Click here for active Employees</a></li>
                </ol>
              </nav>
            </div>
            <div class="row">
