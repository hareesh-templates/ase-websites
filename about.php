...
<head>
    <meta charset="utf-8">
    <title>Eswari Group / Interiors_About || Best interior design in Visakhapatnam & Hyderabad</title>
    <link rel="icon" href="./img/egTitleIcon.png">

    <meta content="width=device-width, initial-scale=1.0" name="viewport">

    <!-- SEO meta tags -->
    <meta name="title" content="Eswari Group | Best interior design in Visakhapatnam & Hyderabad">
    <meta name="description" content=" Our house interior designers are carefully chosen and they are the best interior designers in Vishakhapatnam.
        We provide residential interior design, commercial interior design, office interior design, hospital interior design,
        Home Automation and renovation services.">
    <meta name="keywords" content="Interior design, Interior designers near me, Modern interior designers, Bad room interior in Vizag, 
        ...
        Best interior design company Visakhapatnam, luxury interior design services in Vizag.">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="d-flex flex-column align-items-center justify-content-center bg-primary h-100 py-5 px-3">
                        ...
                        <h4 class="display-3 mb-3">Extensive</h4>
                ...
                <div class="col-lg-7 m-0 my-lg-5 pt-5 pb-5 pb-lg-2 pl-lg-5">
                    ...
                    <h1 class="mb-4 section-title">We are among the top interior designers of the country.</h1>
                    <p>
                        Your dream home is just a few steps away with ASE INFRASTRUCTURES. Experience elegant and
                        sophisticated interiors at small budgets.
                    </p>
                    <div class="row py-2">
                        <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mt-5 py-5 pr-lg-5">
                    ...
                    <h1 class="mb-4 section-title">Decades Of Experience In The Field Of Interior Designing</h1>
                    <p class="mb-4">
                        We got personalized designs for every budget. Long lasting decor that leaves an impact on your
                        state of mind.
                    </p>
                    <ul class="list-inline">
                        <li>
                            <h5><i class="far fa-check-square text-primary mr-3"></i>10+ Years Experience</h5>
                        </li>
                        <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="px-4 h-100 bg-primary d-flex flex-column align-items-center justify-content-center">
                        <h6 class="text-white font-weight-normal text-uppercase mb-3">Our Team</h6>
                        <h1 class="mb-0 text-center">Meet Our Team Members</h1>
                    </div>
                </div>
                <div class="col-md-8 col-sm-6 p-0 py-sm-1">
                    <div class="position-relative p-0 py-sm-3 d-flex">
                        <div class="team d-flex flex-column text-center mx-3 w-50 p-5">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/team1.jpg" alt="">
                                <div class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                                    <a class="btn btn-outline-primary text-center mr-2 px-0" style="width: 2rem; height: 2rem;" href="https://mobile.twitter.com/eswari_group"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-primary text-center mr-2 px-0" style="width: 2rem; height: 2rem;" href="https://www.facebook.com/eswarigroupofficial/"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-primary text-center mr-2 px-0" style="width: 2rem; height: 2rem;" href="https://www.instagram.com/eswarigroup/"><i class="fab fa-instagram"></i></a>
                                    <a class="btn btn-outline-primary text-center px-0" style="width: 2rem; height: 2rem;" href="https://in.linkedin.com/company/eswarigroup"><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                            <div class="d-flex flex-column bg-secondary text-center py-3">
                                <h5 class="text-white">I KALYAN CHAKRAVARTHY</h5>
                        ...
                        <div class="team d-flex flex-column text-center mx-3 w-50 p-5">
                            ...
                            <div class="d-flex flex-column bg-secondary text-center py-3">
                                <h5 class="text-white">I NEELIMA</h5>
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start mt-4">
                    ...
                    <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 38px; height: 38px;" href="https://www.facebook.com/eswarigroupofficial/" target="_blank">
