...
if ( class_exists( 'csf' ) ) {
    ...
    $buildbench_show = (isset($buildbench_banner_settings['show'])) ? $buildbench_banner_settings['show'] : true; 
    $buildbench_show_breadcrumb = (isset($buildbench_banner_settings['show_breadcrumb'])) ? $buildbench_banner_settings['show_breadcrumb'] : true;
    ...
    $buildbench_banner_image = ( is_array($buildbench_banner_settings['image']) && $buildbench_banner_settings !== '' && $buildbench_banner_settings['image']['url'] != '') ? 
    ...
    $buildbench_show = true;
    $buildbench_show_breadcrumb = true;
}
...
if(isset($buildbench_show) && $buildbench_show == true): ?>
...
<div id="page-banner-area" class="page-banner-area banner-area" <?php echo wp_kses_post( $buildbench_banner_bg ); ?>>
   ...
   <div class="page-banner-title">
      ...
      <div class="text-center">
         ...
         <?php if($buildbench_show_breadcrumb == true): ?>
