...
<head>
    <meta charset="utf-8"> 
    <title>Eswari Group / Interiors - Blog Detail || <?php echo $title ?></title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="d-flex flex-column text-left mb-4">
                    ...
                    <h1 class="mb-4 section-title"><?php echo $title ?></h1>
                    <div class="d-index-flex mb-2">
                        <span class="mr-3"><a href="http://eswarigroup.com/"><i class="fa fa-user text-primary"></i> Admin</a></span>
                        <span class="mr-3"><a href="https://asetechnologies.in/"><i class="fa fa-folder text-primary"></i> Web Design</a></span>
                        <span class="mr-3" style="color: #DFB163"><i class="fa fa-calendar text-primary"></i> <?php echo date('M j, Y', strtotime($event_date)) ?> </a></span>
                    </div>
                </div>

                <div class="mb-5">
                    <div class="text-center mb-3">
                        <img class="img-fluid w-50 w-md-75" src="./adminpanel/images/imgs/<?php echo $image; ?>" alt="<?php echo $image; ?>">
                    </div>
                ...
                <div class="mb-5 mx-n3">
                    ...
                    <div class="owl-carousel service-carousel position-relative">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="card border-1 mb-2" style="height: 520px;">
