...
?>
    ...
    <head>
        ...
        <title>Eswari Group / Interior - Admin Panel || User Info </title>
                ...
                <table class="table">
                    ...
                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                            ...
                            <td>' . $row['password'] . '</td>
                            <td>
                                <input class="btn btn-success" type="text" value="' . (($row['user_type'] == 1) ? "ADMIN" : (($row['user_type'] == 2) ? "Blog Admin" : "User")) . '" readonly>
                            </td>
                            <td>
                                <a href="./userUpdate.php?keyId=' . $row['sno'] . '" class="btn btn-warning">Edit User</a>
                            </td>
                        </tr>
                        ';
                    }
