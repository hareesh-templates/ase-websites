        ...
        <div class="table-responsive">
          ...
          <table class="example table table-striped table-bordered nowrap" style="width:100%">
            ...
            <tbody>
              ...
              <?php $no = 1;
              $sql = $conn->query("SELECT * FROM  header_images ");
              // var_dump($sql);
              ...
              while ($result = $sql->fetch(PDO::FETCH_ASSOC)) { ?>
                ...
                <tr>
                  ...
                  <td> <a href="header_imagesadd.php?id=<?php echo $result['id'] ?>" class="btn btn-outline-success">Edit </a>
