...
if($_GET['id'] != ''){ 
  ...
  $id=$_GET['id'];
    $sql = $conn->query("SELECT * FROM gallery where id='$id' ");
      ...
      <div class="row justify-content-center">
         <div class="col-md-12">
            <div class="card">
               ...
               <div style="padding-bottom: 20px;"><a href="gallery_view.php"><button style="float: right;" class="btn btn-dark" type="button"><span class="far fa-arrow-alt-circle-left "> </span>  Back </button></a>
               Add Or Edit Gallery</div>
             </div>
                  <div class="card-body">
              ...
              <?php } ?>
                  ...
                  <i><b>Note :</b> Only Jpeg, jpg, png format images are allowed <br> Please upload ( 370 X 264 ) pixel images to maintain design </i></div>
                  </div>
...
window.location.href = "gallery_add.php?msg=imgerror";
  </script>
...
<?php }
  ...
  $p_link=$p_link1.'-'.rand(1,9999); 
   ...
   $stmt1 = $conn->prepare("INSERT INTO gallery (title,image) VALUES (:title,:image)");
...
<script type="text/javascript">
    window.location.href = "gallery_view.php?msg=success";
    </script>
...
$image=$result['image'];
  ...
  $stmt1 = $conn->prepare("UPDATE gallery SET title=:title,image = :image WHERE id = :id ");
...
<script type="text/javascript">
    window.location.href = "gallery_view.php?msg=edited";
    </script>
