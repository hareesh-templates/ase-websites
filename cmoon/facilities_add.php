      ...
      <div class="row justify-content-center">
         ...
         <div class="col-md-12">
            ...
            <div class="card">
               ...
               <div style="padding-bottom: 20px;"><a href="facilities_view.php"><button style="float: right;" class="btn btn-dark" type="button"><span class="far fa-arrow-alt-circle-left "> </span>  Back </button></a>

               Add Or Edit Facilities</div>
              ...
              <?php } ?>
                  ...
                  <i><b>Note :</b> Only Jpeg, jpg, png format images are allowed <br> Please upload ( 363 X 265 ) pixel images to maintain design </i></div>
