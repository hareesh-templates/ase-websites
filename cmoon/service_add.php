      ...
      <div class="row justify-content-center">
         <div class="col-md-12">
            <div class="card">
               ...
               <div style="padding-bottom: 20px;"><a href="service_view.php"><button style="float: right;" class="btn btn-dark" type="button"><span class="far fa-arrow-alt-circle-left "> </span>  Back </button></a>
               Add Or Edit Service</div>
             </div>
                  <div class="card-body">
              ...
              <?php } ?>
                  ...
                  <i><b>Note :</b> Only Jpeg, jpg, png format images are allowed <br> Please upload ( 1500 X 844 ) pixel images to maintain design </i></div>
                  </div>
...
window.location.href = "service_add.php?msg=imgerror";
  </script>
...
<?php }
  ...
  $p_link=$p_link1.'-'.rand(1,9999); 
   ...
   $stmt1 = $conn->prepare("INSERT INTO service (title,sub_title,image, description) VALUES (:title,:sub_title,:image,:description)");
...
<script type="text/javascript">
    window.location.href = "service_view.php?msg=success";
    </script>
...
$image=$result['image'];
  ...
  $stmt1 = $conn->prepare("UPDATE service SET title=:title,sub_title=:sub_title,image = :image,description=:description WHERE id = :id ");
...
<script type="text/javascript">
    window.location.href = "service_view.php?msg=edited";
    </script>
